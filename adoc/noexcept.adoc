...
* from {CPP} virtual function overrides;
...
* It is intrusive, so it couldn't be used in many practical cases, for example when reporting errors from a C callback or when overriding a virtual function.
