...
boost
	...
	noexcept_succeeded( T const & x ) noexcept
		{
		return noexcept_result_traits<T>::succeeded(x);
		}
	template <class T>
	T
	noexcept_error_result() noexcept
		{
		return noexcept_result_traits<T>::error_result();
		}
	template <class T>
	...
	noexcept_success_value( T const & x ) noexcept
		...
		return noexcept_result_traits<T>::success_value(x);
		}
	template <class T>
	typename noexcept_result_traits<T>::value_type &
